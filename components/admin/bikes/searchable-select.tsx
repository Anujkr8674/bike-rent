  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={cn(
          "flex w-full items-center justify-between rounded-xl border bg-[#111111] px-4 py-3 text-left text-sm outline-none transition",
          error ? "border-rose-300" : "border-white/10 hover:border-[#FF653F]/40",
        )}
      >
        <span className={value ? "text-white" : "text-zinc-400"}>{value ? selectedLabel : placeholder}</span>
      ...
      {open ? (
        <>
          ...
          <div className="absolute z-50 mt-2 w-full overflow-hidden rounded-xl border border-white/10 bg-[#111111] shadow-xl">
            <div className="relative border-b border-white/5 p-2">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/10 py-2.5 pl-10 pr-3 text-sm outline-none focus:border-[#FF653F]/50"
                autoFocus
              />
            </div>
