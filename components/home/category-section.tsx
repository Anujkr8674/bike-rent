                ...
                <Link href={`/bikes?category=${category.slug}`}>
                  ...
                  >
                    ...
                    <div className="relative flex h-[160px] md:h-[185px] w-full items-center justify-center overflow-visible mb-2 mt-2">
                      ...
                      {category.imageUrl && (
                        <Image
                          src={encodeURI(decodeURI(category.imageUrl))}
                          alt={category.name}
                          fill
                          unoptimized
                          sizes="(max-width: 768px) 100vw, 33vw"
                          className="object-contain scale-[1.52] transition-transform duration-500 group-hover:scale-[1.60] z-10 drop-shadow-[0_15px_15px_rgba(0,0,0,0.6)]"
                          onError={(e) => {
