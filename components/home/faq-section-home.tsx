      ...
      <div className="page-wrap relative z-10">
        <div className="grid items-start gap-10 lg:grid-cols-[4.5fr_7.5fr] lg:gap-14">
          <SectionReveal className="lg:sticky lg:top-28">
            ...
            <div className="relative mt-8 w-full aspect-[4/3] sm:aspect-[16/10] lg:aspect-[4/5] max-h-[400px] lg:max-h-[580px] overflow-hidden rounded-3xl border border-zinc-200 shadow-2xl shadow-blue-500/10">
              <Image
